...
export const packages = [
  {
    title: 'Starter Website – Budget-Friendly (For small businesses & startups)', // Emphasize speed and affordability
    description:
    ...
    price: '$500 - $1,000', // Reduced price range
    benefits: [
      '3-5 page website (perfect for new businesses)', // Highlight appropriate website size
      'SEO optimization (get found on Google)',
      'Mobile-responsive design (great for all devices)',
      '1-2 revisions (ensure your satisfaction)',
  ...
  },
  {
    ...
    price: '$2,500 - $4,000',  // Price remains the same
    benefits: [
      '6-10 page custom website (tailored to your needs)',  // Emphasize customization
      'Advanced SEO optimization (boost search rankings)',   // Stronger benefit description
      'Custom graphics & animations (enhance brand identity)', // Highlight visual appeal
      '3-5 revisions (ensure perfection)',  // Focus on client satisfaction
      'Priority support (fast response to issues)',  // Explain priority support benefit
...

  {
    ...
    price: '$7000 - $12,000',  // Price remains the same
    benefits: [
      '13+ page website (extensive customization & features)',  // Highlight extensive capabilities
      'Comprehensive SEO optimization (maximize traffic & leads)',   // Strengthen benefit descriptions
      'Custom database integration (for complex data management)', // Explain database integration benefit
      '6-10 revisions (to achieve perfection)',  // Focus on client satisfaction
      'Dedicated project manager (personalized support)',  // Emphasize dedicated support
      'Social Media Integration',
    ],
